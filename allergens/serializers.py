...
# -----------------------------------------------------------------------------
# Serializers لواجهات الحساسيّات والإضافات (E-Num)
...
from core.dictionary_models import KeywordLexeme  # موديل المعجم النصّي
from core.models import Ingredient, Allergen
from core.models import Allergen, Ingredient      # إذا كانت في app اسمها core
...
class AdditiveCodeSerializer(serializers.ModelSerializer):
    ...
    """
    # نُبقي نفس أسماء الواجهة الأمامية
...
# ========================= =======
# KeywordLexeme (مصطلحات الحساسيّات/المكوّنات)
...
# ===== Ingredient (تبسيط للوحة القاموس) =====
