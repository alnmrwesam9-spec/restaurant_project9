...
class EmailOrUsernameTokenObtainPairSerializer(TokenObtainPairSerializer):
    ...
    def validate(self, attrs):
        ...
        if isinstance(identifier, str):
            ...
            # Normalize the (possibly trimmed) identifier back into attrs
            # so plain-username logins also benefit from trimming.
            ...
            if "@" in identifier:
                ...
                try:
                    ...
                    # Map email to the concrete username value expected by SimpleJWT
                    attrs[self.username_field] = getattr(u, User.USERNAME_FIELD, u.username)
                except Exception:
                    # fall back to default behavior which will raise 401
                    pass
