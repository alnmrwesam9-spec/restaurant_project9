  ...
  const HeaderFull = (
    ...
    >
      ...
      <Box sx={{ position: "relative" }}>
        ...
        {/* زر + يفتح اختيار الصورة (يظهر دومًا، والنصي يظهر فقط على الشاشات الكبيرة) */}
        <IconButton
          component="label"
          size="small"
          disabled={busy}
      ...
      <Box sx={{ minWidth: 0 }}>
        {/* وضوح الخط: text.primary بدل درجات باهتة */}
        <Typography variant="subtitle2" noWrap sx={{ fontWeight: 700, color: "text.primary" }}>
          {displayName}
        </Typography>

        {/* زر نصي يظهر فقط على الشاشات الكبيرة */}
        <Button
          size="small"
          variant="text"
          component="label"
        ...
        >
          ...
          <input
            ...
            accept="image/*"
            onChange={onFile}
            aria-label="upload avatar large"
          />
        </Button>
      </Box>
              ...
              >
                ...
                <ListItemText
                  primary={
                    <Typography
                      variant="body2"
                      sx={{ fontWeight: selected ? 700 : 500, color: "text.primary" }} // وضوح أقوى
                    >
                      {m.name}
                    </Typography>
                  }
