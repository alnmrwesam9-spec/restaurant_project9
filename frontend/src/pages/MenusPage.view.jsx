...
export default function MenusPageView() {
  ...
  return (
    ...
    >
      ...
      {/* الحاوية القابلة للتمرير العمودي (ليست window) */}
      <Box
        ...
        >
          ...
          {loading ? (
            ...
            <Grid container sx={{ overflowX: 'clip', pb: { xs: 8, md: 4 } }}>
              <Grid item xs={12}>
                <Box sx={{ maxWidth: CONTENT_MAX, mx: 'auto', minWidth: 0 }}>
                  <Alert severity="info">ℹ️ {t('empty.no_menus_yet')}</Alert>
                </Box>
              </Grid>
            </Grid>
          ) : (
                ...
                <Box sx={{ maxWidth: CONTENT_MAX, mx: 'auto', minWidth: 0 }}>
                  ...
                  >
                    <Grid container sx={{ overflowX: 'clip', pb: { xs: 8, md: 4 } }}>
                      ...
                      {/* Placeholder لعرض الهيرو حتى يجهز */}
                      {displayLoading && (
                        <Grid
                          item
                          xs={12}
